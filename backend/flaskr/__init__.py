        ...
        try:
            if quiz_category is not None:
                ...
                formatted_all_category_based_questions = \
                    [question.format() for question in category_based_questions]
            ...
            '''
                Randomly select a question from the unseen_questions, only if there are still 
                unattempted questions in the list
            '''
